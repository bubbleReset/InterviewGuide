...
<p  id="为何需要把TCPIP协议栈分成5层或7层开放式回答"></p>
...
<p  id="对于FINWAITCLOSEWAIT状态和TIMEWAIT状态你知道多少"></p>
...
<p id="可以解释一下RTORTT和超时重传分别是什么吗"></p>
